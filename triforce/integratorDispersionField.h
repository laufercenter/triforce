...
#ifndef INTEGRATOR_DISPERSION_FIELD_H_
#define INTEGRATOR_DISPERSION_FIELD_H_
...
class IntegratorDispersionField: public Integrator{
	
public:
	IntegratorDispersionField();
	IntegratorDispersionField(vector<Interpolator*> data);
...
#endif //INTEGRATOR_DISPERSION_FIELD_H_
